                ...
                <div class="sngl-top">
                                    ...
                                    ?>
                                        <li data-thumb="images/s-1.jpg">
                                            <div class="thumb-image">
                                                <img src="images/<?=$pic->img; ?>" data-imagezoom="true" class="img-responsive" alt=""/>
                                            </div>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <h5 class="item_price"><?= $curr['symbol_left']?><?= ceil($product->price * $curr['value']);?><?= $curr['symbol_right']?>
                            </h5>
                            <?php if($product->old_price): ?>
                                <small><del><?= $curr['symbol_left']?> <?=ceil($product->old_price * $curr['value']);?> <?= $curr['symbol_right']?></del></small>
                            <?php endif; ?>
                            <?= $product->content;?>
                            <div class="available">
                                <ul>
                            ...
                            <div class="col-md-4 product-left p-left">
                                <div class="product-main simpleCart_shelfItem">
                                    ...
                                    <div class="product-bottom">
                                        ...
                                        <p>Explore Now</p>
                                        <h4><a class="item_add add-to-cart-link" href="card/add?id=<?=$item['id'];?>" data-id="<?=$item['id']?>">
                                                <i></i></a>
                                            <span class=" item_price"><?= $curr['symbol_left']?><?= ceil($item['price'] * $curr['value']);?><?= $curr['symbol_right']?></span>
